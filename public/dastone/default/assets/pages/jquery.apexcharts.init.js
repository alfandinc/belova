...
(chart = new ApexCharts(document.querySelector("#apex_area1"), options)).render(), $(document).ready(function() {
    var e = {
            annotations: {
                yaxis: [{
                    y: 30,
...
(chart = new ApexCharts(document.querySelector("#apex_radialbar3"), options)).render(), Apex.grid = {
    padding: {
        right: 0,
        left: 0
    }
