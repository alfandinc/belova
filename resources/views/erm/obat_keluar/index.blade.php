...
<div class="container-fluid mt-4">
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-bordered" id="obatKeluarTable">
                <thead>
                    <tr>
                        <th>Nama Obat</th>
                        <th>Jumlah Keluar</th>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="detailModalLabel">Detail Obat Keluar</h5>
...
$(function() {
    ...
    $('#obatKeluarTable').on('click', '.btn-detail', function() {
