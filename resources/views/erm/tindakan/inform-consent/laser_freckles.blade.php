<div class="container">
    <form id="informConsentForm" method="POST" action="{{ route('erm.tindakan.inform-consent.save') }}">
        ...
        <h4 class="text-center mb-4">INFORMED CONSENT LASER FRECKLES</h4>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="mb-0">Persetujuan Tindakan Laser Freckles</h5>
            </div>
            <div class="card-body">
                <p>Saya yang bertanda tangan dibawah ini menyetujui untuk dilakukan tindakan Laser Freckles dengan ketentuan:</p>
                <ol>
