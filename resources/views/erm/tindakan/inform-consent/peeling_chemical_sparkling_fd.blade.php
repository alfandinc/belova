<div class="container">
    <form id="informConsentForm" method="POST" action="{{ route('erm.tindakan.inform-consent.save') }}">
        ...
        <h4 class="text-center mb-4">INFORMED CONSENT PEELING CHEMICAL SPARKLING FD</h4>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="mb-0">Persetujuan Tindakan Peeling Chemical Sparkling FD</h5>
            </div>
            <div class="card-body">
                <p>Saya, yang bertanda tangan di bawah ini, dengan ini menyetujui untuk menjalani perawatan Chemical Peeling Sparkling FD di Klinik Pratama Belova Skin & Beauty Center.</p>
