<div class="container">
    <form id="informConsentForm" method="POST" action="{{ route('erm.tindakan.inform-consent.save') }}">
        ...
        <h4 class="text-center mb-4">INFORMED CONSENT BRIGHTENING IPL ARM PIT HAIR</h4>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="mb-0">Persetujuan Tindakan Brightening IPL Arm Pit Hair</h5>
            </div>
            <div class="card-body">
                ...
                <p>Alternatif: Terdapat beberapa alternatif untuk perawatan kulit, seperti krim atau losion topikal, peeling kimia, atau prosedur laser lainnya. Dokter atau terapis telah membahas opsi yang paling sesuai dengan kondisi kulit saya.
</p>
