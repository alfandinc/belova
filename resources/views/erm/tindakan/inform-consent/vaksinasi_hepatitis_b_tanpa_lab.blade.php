<div class="container">
    <form id="informConsentForm" method="POST" action="{{ route('erm.tindakan.inform-consent.save') }}">
        ...
        <h4 class="text-center mb-4">INFORMED CONSENT VAKSINASI HEPATITIS B TANPA PEMERIKSAAN LABORATORIUM</h4>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <ol>
                        <li>Saya telah mendapatkan penjelasan dari dokter/tenaga medis mengenai pentingnya 
pemeriksaan laboratorium sebelum dilakukan tindakan/terapi.  </li>
                        <li>Saya memahami bahwa pemeriksaan laboratorium dapat membantu dokter 
mengetahui kondisi kesehatan saya secara lebih akurat dan mengurangi risiko yang 
mungkin timbul. </li>
                        <li>Saya menyadari dan memahami risiko yang mungkin terjadi apabila tindakan 
dilakukan <strong>tanpa</strong> pemeriksaan laboratorium terlebih dahulu. </li>
                        <li>Dengan penuh kesadaran, saya memilih untuk <strong>tidak menjalani pemeriksaan 
laboratorium, dan tetap menyetujui dilakukan tindakan/terapi sesuai dengan 
kebutuhan saya. </strong></li>
                        <li>Saya melepaskan pihak dokter/klinik dari tuntutan hukum di kemudian hari terkait 
risiko atau komplikasi medis yang dapat terjadi akibat keputusan saya ini. </li>
