...
<h3 class="center">INFORMED CONSENT {{ strtoupper($tindakan->nama) }}</h3>
<table class="no-border">
  <tr>
    <td colspan="2">
      <p>Saya yang bertanda tangan dibawah ini menyetujui untuk dilakukan tindakan {{ $tindakan->nama }} dengan ketentuan:</p>
      <ol>
