<div class="container">
    <form id="informConsentForm" method="POST" action="{{ route('erm.tindakan.inform-consent.save') }}">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p>Saya, yang bertanda tangan di bawah ini, dengan ini memberikan persetujuan untuk menjalani perawatan RF TRIPOLAR di Klinik Pratama Belova Skin & Beauty Center.</p>
                <p>Deskripsi Tindakan: Perawatan RF (Radiofrequency) TRIPOLAR adalah prosedur perawatan kulit yang menggunakan gelombang radiofrekuensi untuk merangsang produksi kolagen dan mengencangkan kulit. Tujuan perawatan ini adalah untuk mengurangi kerutan, meremajakan kulit, dan meningkatkan elastisitas kulit.</p>
                <p>Manfaat: Perawatan RF TRIPOLAR dapat memberikan manfaat sebagai berikut:</p>
                <ol>
                ...
                <p>Risiko dan Komplikasi: Meskipun perawatan RF TRIPOLAR umumnya dianggap aman, tetapi setiap prosedur medis memiliki risiko. Beberapa risiko dan komplikasi yang mungkin terjadi termasuk:</p>
                <ol>
