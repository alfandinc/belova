                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="kategori_pegawai" name="kategori_pegawai" class="form-control select2">
                                ...
                                <option value="medis" {{ old('kategori_pegawai') == 'medis' ? 'selected' : '' }}>Medis</option>
                                <option value="non-medis" {{ old('kategori_pegawai') == 'non-medis' ? 'selected' : '' }}>Non-Medis</option>
                                <option value="manajemen" {{ old('kategori_pegawai') == 'manajemen' ? 'selected' : '' }}>Manajemen</option>
                            </select>
                        </div>
                    </div>
