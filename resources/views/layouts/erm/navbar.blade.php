            ...
            <div class="brand mt-3">
                <a href="/erm" class="logo">
                    <span>
                        ...
                        <img src="{{ asset('img/logo-premiere.png')}}" alt="logo" class="logo-light" style="width: auto; height: 50px;">

                        <!-- Dark-theme logo (for light background) -->
                        <img src="{{ asset('img/logo-premiere-bw.png')}}" alt="logo" class="logo-dark" style="width: auto; height: 50px;">
