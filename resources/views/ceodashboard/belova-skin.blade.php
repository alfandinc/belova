            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between flex-wrap mb-3" style="gap:12px;">
                    <div>
                        ...
                        <p class="text-muted mb-0">Statistik kunjungan untuk Klinik ID = 2 (status_kunjungan = 2).</p>
                    </div>
    ...
    <script>
        (function(){
            ...
            function fetchAllPatientRevenue() {
                ...
                fetch('/ceo-dashboard/clinic/2/patient-revenue-rankings' + buildDoctorQuery())
                    .then(function(res){ if (!res.ok) throw res; return res.json(); })
                    .then(function(payload){
                        if (!payload || !payload.ok) throw new Error('Invalid response');
            ...
            function fetchSpendClassVisits(classKey, classLabel) {
                ...
                fetch('/ceo-dashboard/clinic/2/spend-class-visits/' + encodeURIComponent(classKey) + buildDoctorQuery())
                    .then(function(res){ if (!res.ok) throw res; return res.json(); })
                    .then(function(payload){
                        if (!payload || !payload.ok) throw new Error('Invalid response');
            ...
            function fetchItemRevenueDetails(itemType, itemId, itemName) {
                ...
                var endpoint = itemType === 'tindakan'
                    ? '/ceo-dashboard/clinic/2/treatment/' + encodeURIComponent(itemId) + '/revenue-details'
                    : '/ceo-dashboard/clinic/2/obat/' + encodeURIComponent(itemId) + '/revenue-details';
