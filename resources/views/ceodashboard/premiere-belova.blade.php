        ...
        (function(){
            ...
            function fetchItemRevenueDetails(itemType, itemId, itemName) {
                ...
                var endpoint = itemType === 'tindakan'
                    ? '/ceo-dashboard/clinic/1/treatment/' + encodeURIComponent(itemId) + '/revenue-details'
                    : '/ceo-dashboard/clinic/1/obat/' + encodeURIComponent(itemId) + '/revenue-details';
