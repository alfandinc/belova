                    ...
                    <div class="card rounded-3" style="border-radius: 15px; overflow: hidden;">
                        <div class="card-body p-0 auth-header-box" style="background-color: #0d6efd;">
                            <div class="text-center p-3">
                                <h1 class="mt-3 mb-1 font-weight-semibold text-white"><i class="fas fa-coins mr-2"></i>Finance Login</h1>
                                <h5 class="text-white">Welcome to Finance Belova, login to continue.</h5>
                            </div>
                        </div>
