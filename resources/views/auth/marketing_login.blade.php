...
<head>
    <meta charset="utf-8" />
    <title>Login | Marketing</title>  <!-- Dynamic title -->
...
<body class="account-body accountbg-dark">
                    ...
                    <div class="card rounded-3" style="border-radius: 15px; overflow: hidden;">
                        <div class="card-body p-0 auth-header-box" style="background-color: #0d6efd;">
                            <div class="text-center p-3">
                                <h1 class="mt-3 mb-1 font-weight-semibold text-white"><i class="fas fa-chart-line"></i> Marketing Login</h1>
                                <h5 class="text-white">Welcome to Marketing Belova, login to continue.</h5>
                            </div>
                        </div>
